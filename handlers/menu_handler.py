...
async def menu_handler(message: types.Message):
    text = """👋 Шуморо бот Dodopizza дар Душанбе хуш омадед мегӯяд!

🚗  Дастрасии зуд ва осон

🍕 Танҳо дар Dodopizza – беҳтарин пицца бо рецептҳои беназир!
🐓 100% маҳсулоти Ҳаляль
⏲️ Вақти дастрасӣ: аз 11:00 то 23:00
⌛ Дастрасӣ дар 60 дақиқа
🏙️ Дар шаҳр – 35 сомонӣ
🏡 Берун аз шаҳр – 85 сомонӣ
❗💲 Минимум фармоиш: 150 сомонӣ
🙋‍♀️ Дастгирӣ: @dodo_supp
